...
student_id int NULL,
subject_id int NULL,
progress_result varchar (3) NULL,
progress_date date NULL,
CONSTRAINT FK_PROGRESS_SUBJECT FOREIGN KEY (subject_id) REFERENCES subject(id_subject) ON DELETE SET NULL ON UPDATE CASCADE,
CONSTRAINT FK_PROGRESS_STUDENT FOREIGN KEY (student_id) REFERENCES student(id_student) ON DELETE SET NULL ON UPDATE CASCADE,
PRIMARY KEY("id_subject")
);