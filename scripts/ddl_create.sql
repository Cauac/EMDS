...
CREATE TABLE questionnaire(
    ...
    duty_start date,
    duty_end date
    CONSTRAINT FK_ADDRESS FOREIGN KEY (address_id) REFERENCES address(id_address) ON DELETE SET NULL ON UPDATE CASCADE
    CONSTRAINT FK_PARENT_ADDRESS FOREIGN KEY (parents_address_id) REFERENCES address(id_address) ON DELETE SET NULL ON UPDATE CASCADE
);
