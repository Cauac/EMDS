...
<html>
    <head>
        ...
        <emds:style/>
        <title><emds:title title="Ксерокопия паспорта"/></title>
    </head>
    <body>
        <emds:header/>
        ...
        <spring:url value="/documents/passport" var="documentURL"/>

        <div class="well center-div span7">

            <h4 class="center"> ${student.lastName} ${student.firstName} :: Ксерокопия паспорта</h4>
