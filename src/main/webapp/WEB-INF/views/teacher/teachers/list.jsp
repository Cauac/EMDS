    ...
    <table class="table table-condensed offset1 span11">
        ...
        <c:forEach var="teacher" items="${teachers}">
            <tr class="tbody">
                ...
                <td>
                    <spring:url var="editTeacher" value="/teacher/teachers/edit">
                ...
                <td>
                    <spring:url var="removeTeacher" value="/teacher/teachers/remove">
                        <spring:param name="id" value="${teacher.id}"/>
                    </spring:url>
...
<div class="offset1 span11">
    <spring:url var="addTeacher" value="/teacher/teachers/add"/>
