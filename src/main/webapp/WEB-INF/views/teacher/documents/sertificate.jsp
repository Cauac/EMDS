...
<head>
    ...
    <mytags:style/>
    <title>ВК ВГУ :: Справка ВВК</title>
</head>
<body>
<mytags:header/>
...
<spring:url value="/teacher/documents/sertificate" var="documentURL"/>

<div class="well offset3 span7">

    <h4 class="center"> ${abiturient.lastName} ${abiturient.firstName} :: Справка ВВК</h4>
