...
<c:if test="${fn:length(students) gt 0}">
    <table class="table table-condensed offset1 span11">
        ...
        <c:forEach var="student" items="${students}">
            <tr>
                <td><a href="./students/info?id=<c:out value="${student.id}" />"> <c:out value="${student.lastName}"/>
                ...
                <td>
                    <a onclick="return confirm('Вы действительно хотите удалить студента?')"
                       href="./students/remove?id=<c:out value="${student.id}" />">
