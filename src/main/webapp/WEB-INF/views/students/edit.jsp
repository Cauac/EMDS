...
<html>
    ...
    <body>
        ...
        <spring:hasBindErrors name="student">
            <emds:error message="Информация не сохранена. Проверьте правильность заполнения формы."/>
        ...
        <form:form action="${documentURL}" method="post" cssClass="form-horizontal" modelAttribute="student" enctype="multipart/form-data">
            ...
            <div class="well center-div span11">
                ...
                <div class="center">
                    <spring:url var="abiturients" value="/students"/>
                    <button class="btn" type="submit"> <emds:icon icon="7" text="Сохранить"/> Сохранить информацию </button>
